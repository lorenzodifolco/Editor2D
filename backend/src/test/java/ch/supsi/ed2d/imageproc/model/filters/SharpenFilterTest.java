...
class SharpenFilterTest {
    ...
    void sharpenFilter() {
        ...
        assertDoesNotThrow(() -> {
            ...
            espectedResult.setPixel(new Pixel(0.6f, 0.6f, 0.6f, 0.0f), 0, 2);

            espectedResult.setPixel(new Pixel(0.8f, 0.8f, 0.8f, 0.0f), 1, 0);
            ...
            espectedResult.setPixel(new Pixel(0.6f, 0.6f, 0.6f, 0.0f), 2, 2);

            Image result = SharpenFilter.getInstance().apply(img);
